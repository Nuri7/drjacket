...
export const dictionaries = {
  nl: {
    ...
    hero: {
      ...
      subline: 'Dé (k)Leermaker voor Uw beste Leren Jas',
      cta: 'Plan uw Intake',
    ...
    testimonials: {
      ...
      subtitle: 'Google Reviews — 5 Sterren',
      items: [
        {
          name: 'Sophie van der Berg',
          text: 'Maurice heeft mijn vintage leren jas volledig getransformeerd. Het resultaat is ongelooflijk — beter dan nieuw! Absolute vakman.',
          rating: 5,
        },
        {
          name: 'Thomas de Groot',
          text: 'Na jaren zoeken eindelijk iemand gevonden die écht verstand heeft van leer. De rits vervanging is perfect uitgevoerd, je ziet er niks van.',
          rating: 5,
        },
        {
          name: 'Elena Rossi',
          text: 'I brought my Italian leather jacket from Milan to Amsterdam specifically for Maurice. His craftsmanship is unmatched. Worth every euro.',
          rating: 5,
        },
        {
          name: 'Mark Jansen',
          text: 'Mijn motorjas had flinke schade na een val. Maurice heeft hem onzichtbaar hersteld. Echt een kunstenaar met leer.',
          rating: 5,
        },
      ],
    },
    cta: {
      title: 'Klaar om Uw Jas Nieuw Leven te Geven?',
      subtitle: 'Maak een afspraak voor een gratis intake gesprek',
      button: 'Plan Uw Intake',
      phone: 'Of bel direct',
    },
    contact: {
      badge: 'Contact',
  ...
  en: {
    nav: {
      ...
      callNow: 'Call Now',
      whatsapp: 'WhatsApp',
      planIntake: 'Book Intake',
    },
    hero: {
      headline: 'Your Leather Jacket Deserves the Best',
      subline: 'The Leather Tailor for Your Finest Leather Jacket',
    ...
    testimonials: {
      ...
      subtitle: 'Google Reviews — 5 Stars',
      items: [
        {
          name: 'Sophie van der Berg',
          text: 'Maurice completely transformed my vintage leather jacket. The result is incredible — better than new! An absolute craftsman.',
          rating: 5,
        },
        {
          name: 'Thomas de Groot',
          text: 'After years of searching, finally found someone who truly understands leather. The zip replacement was perfectly executed.',
          rating: 5,
        },
        {
          name: 'Elena Rossi',
    ...
    cta: {
      title: 'Ready to Give Your Jacket New Life?',
      subtitle: 'Book a free intake consultation',
